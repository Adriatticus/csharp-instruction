...
namespace csharp_chapter18_demos
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    MyConsole.PrintL(invoicesList.ToString());
            //}
            ...
            MyConsole.PrintL("__________Invoices with totals over $150_____________");
            ...
            MyConsole.PrintL("__________Join in LINQ Zelda_____________");
            ...
            // p. 593 - exension methods
            // list of invoices totals > 150 ordered by customerid, then by invoiceTotal (desc)
