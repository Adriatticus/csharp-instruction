...
namespace request_number_generator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Hello generations!");
            ...
            for (int i = 0; i < 1001; i++)
            {
                ...
                Console.WriteLine($"We testing shit - {dateStr}");
                ...
                Console.WriteLine(requestNbr.ToString().Substring(requestNbr.Length -4));
            ...
            Console.WriteLine("You have been generated. Goodbye.");
        }
    }
}
